...
//  GlassUI
//
//  Created by Jordan Perry on 3/12/19.
//  Copyright © 2019 WalmartLabs. All rights reserved.
//

import UIKit

/// A base class for `UIControl`s in Glass.
///
/// The main feature of `BaseControl` is conformance to `ViewConstructable`.
///
...
///
/// A secondary feature is that subclasses don't need to implement `init(coder:)`. `BaseControl` marks that initializer
/// as unavailable.
open class BaseControl: UIControl, ViewConstructable {
    // MARK: Initialization
