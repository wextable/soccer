...
/// A base class for `UITableViewHeaderFooterView`s in Glass.
///
/// The main feature of `BaseTableViewHeaderFooterView` is conformance to `ViewConstructable`.
///
...
///
/// A secondary feature is that subclasses don't need to implement `init(coder:)`. `BaseTableViewHeaderFooterView`
/// marks that initializer as unavailable.
open class BaseTableViewHeaderFooterView: UITableViewHeaderFooterView, ViewConstructable {
